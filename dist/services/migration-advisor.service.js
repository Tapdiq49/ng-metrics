...
exports.MigrationAdvisorService = void 0;
class MigrationAdvisorService {
    advise(scanResult, codeAnalysisResults) {
        const steps = [];
        let stepCounter = 1;
        ...
        const hasControlFlowIssues = codeAnalysisResults.some(r => r.issues.some(i => i.type === 'anti_pattern'));
        ...
        const hasRxJsIssues = codeAnalysisResults.some(r => r.issues.some(i => i.type === 'rxjs_issue'));
        if (hasRxJsIssues) {
            steps.push({
                step: stepCounter++,
        ...
        const hasDeprecatedApis = codeAnalysisResults.some(r => r.issues.some(i => i.type === 'deprecated_api'));
...
exports.MigrationAdvisorService = MigrationAdvisorService;
